...
export default function Home() {
  const roles = useMemo(() => ["Full Stack Web Developer"], []);
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid lg:grid-cols-2">
          ...
          <div className="w-full lg:pr-24 mx-auto max-w-3xl">
            ...
            >
             ...
             shadow-lg hover:scale-105 transition-all"
              ...
              <a href="/Tikesh_Aswale_Resume.pdf"
                download
        ...
        <div className="relative hidden lg:block">
          <div
            ...
            style={{
              ...
              background: "conic-gradient(from 0deg, #1cdbd2, #00bf8f, #302b63, #1cd8d2)"
            }}
          />
          <motion.img src={avator} alt="Tikesh Aswale"
            className="absolute top-1/2 -translate-y-1/2 object-contain select-none poijter-events-none"
            style={{
