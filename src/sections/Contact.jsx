          ...
          <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col">
              ...
              >
                ...
                <option value="Mobile Application" className="text-black">Mobile App Development</option>
            ...
            <motion.button
              className="bg-blue-600 hover:bg-blue-800 disabled:opacity-60 text-white font-semibold py-3 rounded-md transition"
