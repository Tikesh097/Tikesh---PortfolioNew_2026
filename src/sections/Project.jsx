...
export default function Project() {
  const isMobile = useIsMobile();     // mobile / desktop check
  const sceneRef = useRef(null);      // reference for scroll tracking

  /* -----------------------------
     Project data (memoized)
     Image switches based on device
  --------------------------------*/
  ...
  return (
    <section
      ...
      style={{
        height: `${100 * projects.length}vh`, // scroll length
    ...
    >
      ...
      <div className="sticky top-0 h-screen flex flex-col items-center justify-center">
              ...
              <AnimatePresence mode="wait">
                {activeIndex === idx && (
                  <motion.h3
                    ...
                    className={`block text-center text-[clamp(2rem,3vw,5rem)] text-white/95
        ...
        <div className={`absolute ${isMobile ? "bottom-20" : "bottom-10"
          ...
          <a href={activeProject?.Project_link}
            target="_blank"
